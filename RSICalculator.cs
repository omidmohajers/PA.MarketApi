namespace PA.Trading.UAPI
{
    ...
    {
        public double CalcSMMAUp(UCandle[] candlesticks, double n, int i, double avgUt1)
        {
        ...
        public double CalcSMMADown(UCandle[] candlesticks, double n, int i, double avgDt1)
        {
            if (avgDt1 == 0)
            {
        ...
        public double[] CalculateRSIValues(UCandle[] candlesticks, int n)
        {
        ...
        public double[] CalculateRSIValuesV2(UCandle[] candlesticks, int n)
        {
